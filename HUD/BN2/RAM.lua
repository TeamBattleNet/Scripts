...
ram.get.color_pallet = function(offset) return memory.read_u8(ram.addr.color_pallet+offset); end;
ram.set.color_pallet = function(offset, color_pallet) memory.write_u8(ram.addr.color_pallet+offset, color_pallet); end;
