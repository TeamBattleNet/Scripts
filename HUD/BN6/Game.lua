...
game.game_state_names[0x00] = "ow_init";
game.game_state_names[0x04] = "ow";
...
game.game_state_names[0x24] = "chip_trader";
...
function game.in_transition()
    return game.get_game_state() == 0x14;
end

function game.in_splash()
    return (game.get_game_state() == 0xFF or game.get_game_state() == 0xFF);
end
