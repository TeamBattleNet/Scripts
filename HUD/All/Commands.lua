...
function commands.general.teleport_real_world.update_options(option_value)
    ...
    if not option_value then
        ...
        commands.general.teleport_real_world.description = function() return "Select a real world group:"; end;
...
function commands.general.teleport_digital_world.update_options(option_value)
    ...
    if not option_value then
        ...
        commands.general.teleport_digital_world.description = function() return "Select a digital world group:"; end;
