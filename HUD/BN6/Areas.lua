...
areas.names[0x8C][0x00] = "Lab's Comp2";
areas.names[0x8C][0x01] = "Vending Machine Comp";
areas.names[0x8C][0x02] = "Punish Chair Comp";
areas.names[0x8C][0x03] = "Water Machine Comp";
areas.names[0x8C][0x04] = "Symbol Comp";
areas.names[0x8C][0x05] = "Monitor Comp";
areas.names[0x8C][0x06] = "Popcorn Shop Comp";
areas.names[0x8C][0x07] = "Teachers' Room Comp";
areas.names[0x8C][0x08] = "Pipe Comp";
areas.names[0x8C][0x09] = "Observation Comp";
areas.names[0x8C][0x0A] = "Oxygen Tank Comp";
areas.names[0x8C][0x0B] = "Principal's Office Comp";
areas.names[0x8C][0x0C] = "Mascot Comp";
areas.names[0x8C][0x0D] = "Stuffed Toy Shop Comp";
areas.names[0x8C][0x0E] = "Dog House Comp";
areas.names[0x8C][0x0F] = "Guide Panel Comp";
